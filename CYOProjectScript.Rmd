...
SPSS_project_data11 <- read_sav("Documents/Project - Eco/SPSS project data11.sav")
projectdata <-SPSS_project_data11

#above describes the loading of the data and the renaming into 'projectdata', to make the coding simpler
